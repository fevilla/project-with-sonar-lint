...
if __name__ == "__main__":
    ...
    items = [
             ...
             item_factory.create(name="Backstage", sell_in=15, quality=20),
             item_factory.create(name="Backstage", sell_in=10, quality=49),
             item_factory.create(name="Backstage", sell_in=5, quality=49),
